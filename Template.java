...
//Quando termina-las tem que colocar na interface de personagem também
    ...
    public void instruçõesCombate() {
        ...
        System.out.println("A granada de bobina custa um fusível além de engrenagens, elas são inuteis contra seres humanos mas danificam de forma pesada robôs inimigos na hora e dão curto tornando seu movimentos mais fracos por um tempo.");
