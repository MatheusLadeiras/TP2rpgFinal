import java.util.*;
// Trabalho feito de forma individual após professora recomendar separar o grupo em questão
...
public class Main {
    public static void main(String[] args) {
        ...
        entrada.desafio();
        completo = false;
        robo.setEngrenagens(300);
        Armazém armazem = new Armazém(completo, luca, robo);
        armazem.desafio();
        robo.setEngrenagens(300);
        Palco palco = new Palco(completo, luca, robo);
        palco.desafio();
        System.out.println("Final alcançado");
    }
}